...
import { BookOpen, Users, RefreshCw, ThumbsUp, Search, ArrowLeft, AlertTriangle } from "lucide-react"
import {
  useAdminStats,
  usePendingBooks,
  useBooks,
...
import type { BookFilters, UserFilters, SwapFilters } from "@/lib/types"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button asChild variant="outline" className="border-amber-700 text-amber-700 hover:bg-amber-50 bg-transparent">
          <Link href="/dashboard">
